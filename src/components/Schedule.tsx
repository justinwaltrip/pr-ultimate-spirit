import { Calendar, Clock, ExternalLink, Info, MapPin } from "lucide-react";
...
const seasons = [
	{
		...
		flyers: [
			{
				label: "Info Session Flyer",
				href: "/flyer/info-session",
				value: "Sept 9 team info session flyer",
			},
		],
		details: [
			...
			{
				label: "Info Session",
				value: "Team info session: September 9, 2026, 6:00 PM - 7:00 PM",
			},
			{
				label: "Clinic",
				value:
							...
							<div className="p-6 space-y-4">
								...
								{"flyers" in season && (
									<div className="space-y-3 border-t border-border pt-4">
										{season.flyers.map((flyer) => (
											<a
												key={flyer.href}
												href={flyer.href}
												className="inline-flex items-center gap-2 rounded-lg border-2 border-primary px-3 py-2 font-display text-xs font-bold uppercase tracking-wider text-primary transition-all duration-200 hover:-translate-y-0.5 hover:bg-primary hover:text-primary-foreground"
											>
