			...
			<div className="container mx-auto px-4">
				<div className="max-w-3xl mx-auto text-center mb-16">
					...
					<p className="text-base sm:text-lg text-muted-foreground leading-relaxed px-2 sm:px-0">
						Pine-Richland Ultimate stands out for combining co-ed participation
						and inclusive team culture with a proven track record in one of the
						country's strongest high school ultimate regions. Players benefit
						from dedicated coaching, competitive league play, and a supportive
						community that treats the team as an integral part of the district's
